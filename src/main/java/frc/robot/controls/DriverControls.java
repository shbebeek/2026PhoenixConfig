...
public class DriverControls {
    ...
    public static void configure(int port, Superstructure superstructure){
        ...
        if(DriverStation.isTest()){
            ...
            controller.leftTrigger().whileTrue(superstructure.setIntakeDeployAndRoll().finallyDo(() -> superstructure.stopIntakeCommand().schedule()).withName("DriverControls.RollIntake"));
            ...
            controller.rightBumper().whileTrue(superstructure.deployIntakeCommand().finallyDo(() -> superstructure.stopIntakePivot().schedule()).withName("DriverControls.DeployIntake"));
            controller.leftBumper().whileTrue(superstructure.returnIntakeCommand().finallyDo(() -> superstructure.stopIntakePivot().schedule()));
            ...
            */
            ...
            controller.povUp().whileTrue(superstructure.stopAllShootingCommand());

            //() -> superstructure.stopAllShootingCommand().schedule())
            ...
            controller.povDown().whileTrue(superstructure.ejectCommand().finallyDo(() -> superstructure.stopIntakeCommand().schedule()));       
            controller.rightStick().whileTrue(superstructure.setIntakeBrakeCommand());
            controller.leftStick().whileTrue(superstructure.setIntakeCoastCommand());
